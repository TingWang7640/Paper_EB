function [xtemp, k, time, FF, Error, a]=FISTA_pow(x,para,ProX,GradF,FvalF,FG_val)
% This function uses IFBS with t_k = ((k.^r)+ss-1)/ss to solve l1-regularized logistic regression
...
%   4. GradF,FvalF,FG_val: calculation of gradient value and function value of f(x)
...
%   6. a: step length
    ...
    while error>ebs        
        tmp=(1-1/(k.^r))/((1+1/k).^r+(ss-1)/(k.^r)); % tmp=(told-1)/t;       
