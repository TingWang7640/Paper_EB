function [xtemp, k, time, FF, Error, a]=FISTA_CD4(x,para,ProX,GradF,FvalF,FG_val)
% This function uses IFBS with t_k = (k+ss-1)/ss to solve l1-regularized logistic regression
